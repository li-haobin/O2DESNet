...
namespace O2DESNet.Demos.FIFOQueues
{
    public class TwoFIFOServers : Component<TwoFIFOServers.Statics>
    {
        ...
        public FIFOServer2<Load> Server1 { get; private set; }
        public Queue<Load> Buffer { get; private set; }
        public FIFOServer2<Load> Server2 { get; private set; }
        #endregion
        ...
        public class Statics : Scenario
        {
            ...
            internal FIFOServer2<Load>.Statics Server1 { get; private set; } 
                = new FIFOServer2<Load>.Statics();
            internal Queue<Load>.Statics Buffer { get; private set; }
                = new Queue<Load>.Statics();
            internal FIFOServer2<Load>.Statics Server2 { get; private set; } 
                = new FIFOServer2<Load>.Statics();
            ...
            public Func<Load, Load, Random, TimeSpan> MinInterDepartureTime1 { get { return Server1.MinInterDepartureTime; } set { Server1.MinInterDepartureTime = value; } }
            ...
            public Func<Load, Load, Random, TimeSpan> MinInterDepartureTime2 { get { return Server2.MinInterDepartureTime; } set { Server2.MinInterDepartureTime = value; } }
