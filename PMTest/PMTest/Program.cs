...
namespace PMTest
{
    class Program
    {
        static void Main()
        {
            Vehicle vehicle = new Vehicle(new Vehicle.Statics { index = 1 }, seed: 0);
            Console.WriteLine("vehicle index: {0}", vehicle.Category.index);
            Console.WriteLine();
            ...
            Console.WriteLine();
            Console.WriteLine("after reset the mileage, the mileage should be:");
            foreach (KeyValuePair<int, double> kvp in vehicle.Mileage)
            {
            ...
            //ControlPoint controlpoint1 = new ControlPoint(new ControlPoint.Statics { index = 1 }, seed: 0);
            //ControlPoint controlpoint2 = new ControlPoint(new ControlPoint.Statics { index = 2 }, seed: 0);
            //ControlPoint controlpoint3 = new ControlPoint(new ControlPoint.Statics { index = 3 }, seed: 0);
            //ControlPoint controlpoint4 = new ControlPoint(new ControlPoint.Statics { index = 4 }, seed: 0);
            //ControlPoint controlpoint5 = new ControlPoint(new ControlPoint.Statics { index = 5 }, seed: 0);
            //Console.WriteLine("Current targets are:");
            //foreach (ControlPoint controlpoint in vehicle.Targets)
            //    Console.WriteLine(controlpoint.Config.index);
            ...
            //Console.WriteLine(vehicle.Position.Config.index);
            ...
            //Path path1 = new Path(new Path.Statics { index = 1}, seed: 0);
            //Path path2 = new Path(new Path.Statics { index = 2}, seed: 0);
            //vehicle.SetTravellingPath(path1);
            //Console.WriteLine();
            //Console.WriteLine("current the vehicle is travelling on the path: {0}", vehicle.TravellingOn.Config.index);
