...
{
    public class MOCBA<TScenario, TStatus, TSimulator> : ParetoFinder<TScenario, TStatus, TSimulator>
        ...
        where TSimulator : Simulator<TScenario, TStatus>
    {
        ...
        public override void Alloc(int budget) { Alloc(budget, MOCBARatios); }
